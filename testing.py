...
# Setting up the environment and embedding model
...
def generate_questions_and_answers():
    ...
    def retrieve_content(
        ...
        boss_aid.n_results = n_results  # Setting the number of results to be retrieved.
        _context = {"problem": message, "n_results": n_results}
        ret_msg = boss_aid.message_generator(boss_aid, None, _context)
        return ret_msg or message

    boss_aid.human_input_mode = "NEVER"  # Disabling human input for boss_aid since it only retrieves content.
    ...
    # Starting chatting with the boss as this is the user proxy agent.
    boss.initiate_chat(
        manager,
        message="Analyze the Google Environmental Report 2022 and generate questions about its content. Provide "
                "insights and explanations based on the report.",
    )
